...
public class SenderReceiverPlace extends AsyncTask<Void, Void, String> {
    ...
    public SenderReceiverPlace(Context c, String query, String urlAddress, RecyclerView rv, ImageView... imageViews) {
        this.c = c;
        this.query = query;
    ...
    protected void onPostExecute(String result) {
        ...
        if(result != null) {
            ...
            if(!result.contains("null")) {
                ...
                ParserPlace pp = new ParserPlace(c, result, rv);
                pp.execute();
