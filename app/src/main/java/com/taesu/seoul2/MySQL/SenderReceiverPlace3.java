...
public class SenderReceiverPlace3 extends AsyncTask<Void, Void, String> {
    ...
    public SenderReceiverPlace3(Context c, String query, String urlAddress, RecyclerView rv, ImageView... imageViews) {
        this.c = c;
        this.query = query;
    ...
    protected void onPostExecute(String result) {
        ...
        if(result != null) {
            ...
            if(!result.contains("null")) {
                ...
                ParserPlace3 pp = new ParserPlace3(c, result, rv);
                pp.execute();
