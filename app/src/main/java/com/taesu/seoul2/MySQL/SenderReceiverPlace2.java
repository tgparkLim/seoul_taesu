...
public class SenderReceiverPlace2 extends AsyncTask<Void, Void, String> {
    ...
    public SenderReceiverPlace2(Context c, String query, String urlAddress, RecyclerView rv, ImageView... imageViews) {
        this.c = c;
        this.query = query;
    ...
    protected void onPostExecute(String result) {
        ...
        if(result != null) {
            ...
            if(!result.contains("null")) {
                ...
                ParserPlace2 pp = new ParserPlace2(c, result, rv);
                pp.execute();
